...
chkeq "real manifests" "$real_ids" "bash,compressed-swap,git,locale,log2ram,motd,motd-updates,motd-weather,pip,pkupd,ram-logging,rconf,skyfield,weewx,zram,"
...
chkeq "defaults match explicit two-dir scan" "$default_ids" "bash,compressed-swap,git,locale,log2ram,motd,motd-updates,motd-weather,pip,pkupd,ram-logging,rconf,skyfield,weewx,zram,"
