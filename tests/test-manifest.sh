...
chkeq "real manifests" "$real_ids" "apache,bash,caddy,compressed-swap,git,jshon,lighttpd,locale,log2ram,motd,motd-updates,motd-weather,nginx,pip,pkupd,ram-logging,rconf,skyfield,webserver,webserver-ssl,webserver-under-construction,weewx,weewx-database-ramdisk,weewx-site-ramdisk,weewx-webroot,zram,"
...
chkeq "defaults match explicit two-dir scan" "$default_ids" "apache,bash,caddy,compressed-swap,git,jshon,lighttpd,locale,log2ram,motd,motd-updates,motd-weather,nginx,pip,pkupd,ram-logging,rconf,skyfield,webserver,webserver-ssl,webserver-under-construction,weewx,weewx-database-ramdisk,weewx-site-ramdisk,weewx-webroot,zram,"
