...
#
# REQUIRED installs the apt baseline. DEFAULT pulls in the MOTD bundle and
# the SkyfieldAlmanac extension (which transitively pulls the weewx apt
# package via skyfield's II_DEPS). OPTIONAL exposes Pi-tuning toggles.
#
...
# yet first-class features): weewx-nginx, weewx-database-ramdisk,
# weewx-onedrive-backup. When those land as features, add them to
# ROLE_FEATURES_OPTIONAL.

# === II_ROLE_BEGIN ===
ROLE_ID="weewx"
ROLE_TITLE="WeeWx - personal weather station"
ROLE_DESCRIPTION="WeeWx weather station software with SkyfieldAlmanac astronomy extension."
ROLE_FEATURES_REQUIRED="pkupd locale"
ROLE_FEATURES_DEFAULT="bash motd skyfield motd-weather"
