...
#
#              caddy is in the stock Debian / Raspberry Pi OS archive on
#              Bookworm + Trixie, so no third-party apt repo setup is
#              needed — a plain apt install suffices. (weewx, by
#              contrast, isn't in the archive and DOES need the
#              apt_add_repo path; see packages/package-weewx.sh.)
#
