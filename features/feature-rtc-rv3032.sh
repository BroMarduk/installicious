...
# Module:      RTC chip-child: RV3032 (I²C, high-accuracy)
# Description: Wires the dtoverlay=i2c-rtc,rv3032 line into
#              /boot/firmware/config.txt and delegates the install
#              state machine to lib/rtc.sh.
#
#              RV3032 is Micro Crystal's high-accuracy RTC —
#              factory-calibrated to ±1 ppm, used in metrology
#              and precision-timing applications.

# === II_MANIFEST_BEGIN ===
II_ID="rtc-rv3032"
II_TITLE="RV3032 — Micro Crystal high-accuracy"
II_CATEGORY="feature"
II_VERSION="1"
II_DEPS="i2c-tools"
