...
# Module:      RTC chip-child: PCF8563 (I²C, low-cost)
# Description: Wires the dtoverlay=i2c-rtc,pcf8563 line into
#              /boot/firmware/config.txt and delegates the install
#              state machine to lib/rtc.sh.
#
#              PCF8563 is the chip on most cheap Chinese RTC modules
#              sold on AliExpress / Amazon under generic labels.
