...
II_CONFLICTS_WITH="database-mariadb"
II_APT_PACKAGES="rclone zstd sqlite3"
II_EDITABLE_CONFIG="WEEWX_BACKUP_RCLONE_CONF WEEWX_BACKUP_REMOTE_NAME WEEWX_BACKUP_REMOTE_ROOT WEEWX_BACKUP_DB_PATH WEEWX_BACKUP_KEEP_DAILY WEEWX_BACKUP_KEEP_WEEKLY WEEWX_BACKUP_KEEP_MONTHLY"
# === II_MANIFEST_END ===
