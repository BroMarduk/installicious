...
# Module:      RTC chip-child: RV1805 (I²C, low-power)
# Description: Wires the dtoverlay=i2c-rtc,rv1805 line into
#              /boot/firmware/config.txt and delegates the install
#              state machine to lib/rtc.sh.
#
#              RV1805 is Micro Crystal's ultra-low-power RTC
#              (~22 nA) — for battery-only deployments where
#              every nanoamp matters.

# === II_MANIFEST_BEGIN ===
II_ID="rtc-rv1805"
II_TITLE="RV1805 — low-power"
II_CATEGORY="feature"
II_VERSION="1"
II_DEPS="i2c-tools"
