...
# Module:      RTC chip-child: M41T62 (I²C, ST Micro)
# Description: Wires the dtoverlay=i2c-rtc,m41t62 line into
#              /boot/firmware/config.txt and delegates the install
#              state machine to lib/rtc.sh.
#
#              M41T62 is STMicroelectronics' serial RTC — appears
#              in some industrial single-board-computer designs
#              and add-on HATs.

# === II_MANIFEST_BEGIN ===
II_ID="rtc-m41t62"
II_TITLE="M41T62 — ST Micro"
II_CATEGORY="feature"
II_VERSION="1"
II_DEPS="i2c-tools"
