...
# Module:      RTC chip-child: RV3028 (I²C, industrial)
# Description: Wires the dtoverlay=i2c-rtc,rv3028 line into
#              /boot/firmware/config.txt and delegates the install
#              state machine to lib/rtc.sh.
#
#              RV3028 is Micro Crystal's industrial-grade RTC —
#              ultra-low-power (~45 nA), used in long-running
#              battery-backed deployments.

# === II_MANIFEST_BEGIN ===
II_ID="rtc-rv3028"
II_TITLE="RV3028 — Micro Crystal industrial"
II_CATEGORY="feature"
II_VERSION="1"
II_DEPS="i2c-tools"
